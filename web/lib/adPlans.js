export const AD_PLAN_CONFIG = {
  ...
  DESTACADO: { key: 'DESTACADO', label: 'Destacado', days: 15, maxCampaigns: 8, maxActiveCampaigns: 3, revenue: 45000 },
  PREMIUM: { key: 'PREMIUM', label: 'Premium', days: 30, maxCampaigns: 20, maxActiveCampaigns: 8, revenue: 80000 },
};
