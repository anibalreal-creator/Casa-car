...
const styles = {
  ...
  smartPreviewImg: { width: '100%', height: '100%', objectFit: 'contain', display: 'block', background: 'transparent' },
  ...
  preview: { width: '100%', maxHeight: 240, objectFit: 'contain', borderRadius: 16, border: '1px solid #dbeafe', background: '#f8fafc' },
