...
const styles = {
  page: { padding: "clamp(14px, 4vw, 40px)", background: "#f5f6fa", minHeight: "100vh", fontFamily: "Arial, sans-serif", overflowX: "hidden" },
  container: { maxWidth: 1000, width: "100%", margin: "auto", boxSizing: "border-box", minWidth: 0, overflow: "hidden" },
  loadingBox: { background: "#fff", padding: 30, borderRadius: 12, border: "1px solid #e5e7eb" },
  card: { background: "#fff", padding: "clamp(16px, 4vw, 30px)", borderRadius: 12, border: "1px solid #e5e7eb", boxSizing: "border-box", maxWidth: "100%", minWidth: 0, overflow: "hidden" },
  ...
  title: { margin: 0, fontSize: "clamp(24px, 7vw, 34px)", color: "#111827", lineHeight: 1.1, overflowWrap: "anywhere", wordBreak: "break-word" },
  price: { marginTop: 10, fontSize: "clamp(24px, 7vw, 30px)", fontWeight: "bold", color: "#111827" },
  ...
  mainImage: { width: "100%", maxWidth: "100%", minWidth: 0, height: "clamp(280px, 58vw, 430px)", background: "#f8fafc", borderRadius: 12, marginTop: 10 },
